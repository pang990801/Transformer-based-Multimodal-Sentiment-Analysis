...
if __name__ == '__main__':
    filepath = '../data/MOSI/mosi_raw_bert.pkl'
    batch_size = 32
    max_seq_len = 50
    ...
    #while True:
        ...
        # 加载完整数据
        testdata = get_ablation_mosi_dataloader(filepath, embedding='bert', batch_size=32, data_type='mosei', max_pad=True, num_workers=0,
        ...
        #     if modality == 'visual':
        #         input_dims.append(35)
        #     elif modality == 'audio':
        #         input_dims.append(74)
        #     elif modality == 'text':
        #         input_dims.append(768)
        # input_dims.sort()
        # 定义模型结构
        print(input_dims)
    ...
    # with open('ablation_mosi_results.csv', 'w', newline='') as file:
    #     writer = csv.writer(file)
    #     writer.writerow(['Fusion Method', 'MAE', 'ACC7', 'Acc5', 'ACC2', 'Corr', 'F1'])
    #     writer.writerows(results)
    #
    # print("All experiments completed. Results saved to ablation_mosi_results.csv.")